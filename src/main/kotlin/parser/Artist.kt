...
fun ResponseParser.parseArtist(obj: JsonElement?): Artist? {
	...
	val title =
		obj.path("header.musicImmersiveHeaderRenderer.title.runs[0].text").maybeStringVal?.nullifyIfEmpty() ?: return null
	val subscribers =
	...
	val thumbnail = ChunkParser.parseThumbnail(obj.path("header.musicImmersiveHeaderRenderer.thumbnail"))
